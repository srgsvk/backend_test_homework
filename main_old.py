...
"""This module is defining who is your charecter and start training."""


def attack(char_name: str, char_class: str) -> str:
    """Attack training function."""
    if char_class == 'warrior':
        return str(f'{char_name} нанёс урон противнику равный '
                   f'{5 + randint(3, 5)}')
    if char_class == 'mage':
        return str(f'{char_name} нанёс урон противнику равный '
                   f'{5 + randint(5, 10)}')
...
def defence(char_name: str, char_class: str) -> str:
    """Deffence training function."""
    if char_class == 'warrior':
        return str(f'{char_name} блокировал {10 + randint(5, 10)} урона')
    if char_class == 'mage':
        return str(f'{char_name} блокировал {10 + randint(-2, 2)} урона')
    if char_class == 'healer':
        return str(f'{char_name} блокировал {10 + randint(2, 5)} урона')


def special(char_name: str, char_class: str) -> str:
    """Your hero speclia attack function."""
    if char_class == 'warrior':
    ...
    if char_class == 'healer':
        return str(f'{char_name} применил '
                   f'специальное умение «Защита {10 + 30}»')


def start_training(char_name: str, char_class: str) -> str:
    """Hero training function."""
    if char_class == 'warrior':
